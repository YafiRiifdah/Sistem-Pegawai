...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="content">
            ...
            <div id="isi">
                <h2>Pengisian data pegawai</h2>
                <form id="formtambahpegawai" action="../lib/ajax.php" method="POST">
                    <input type="hidden" name="op" id="op" value="insertpegawai" />
	                <fieldset>
	                <legend>Keterangan Perseorangan</legend>
	                <label for="nmlengkap">Nama Lengkap</label><input type="text" name="nmlengkap" id="nmlengkap" size="30" maxlength="50">
                    <label for="nip">NIP</label><input type="text" name="nip" id="nip" size="20" maxlength="30">
                    ...
                    <select name="seksi" id="seksi">
					    ...
					    <option value="<?php echo $brs['seksi'];?>"><?php echo $brs['seksi'];?></option>
					    <?php endforeach;?>
                    </select>
					<label for="jabatan">Jabatan</label>
					<select name="jabatan" id="jabatan">
					    <?php foreach($daftarjabatan as $brs):?>
					    <option value="<?php echo $brs['id_jabatan'];?>"><?php echo $brs['jabatan'];?></option>
					    <?php endforeach;?>
                    </select>
                    <a href="#" class="tombol" id="tambahjabatan">Tambah Jabatan</a>
					<label for="tgllahir">Tanggal Lahir</label><input type="text" name="tgllahir" id="tgllahir" size="10" maxlength="20" class="tanggal">
					<label for="tmplahir">Tempat Lahir</label><input type="text" name="tmplahir" id="tmplahir" size="30" maxlength="35">
					...
					<select id="agama" name="agama">
					    ...
					    <option value="konghochu">Konghochu</option>
					</select>
					<label for="kepercayaan">Kepercayaan terhadap Tuhan YME</label><input type="text" name="kepercayaan" id="kepercayaan" size="15" maxlength="20" value="-">
                    ...
                    <input type="text" name="notelp" id="notelp" size="20" maxlength="25" />
					<br><br>
					<fieldset>
					...
					<fieldset>
						...
						<label for="jalan">Jalan</label><input type="text" name="jalan" id="jalan" size="50" maxlength="100">
						<label for="desa">Desa/Kelurahan</label><input type="text" name="desa" id="desa" size="20" maxlength="30">
						<label for="kec">Kecamatan</label><input type="text" name="kec" id="kec" size="20" maxlength="30">
						<label for="kab">Kota/Kabupaten</label><input type="text" name="kab" id="kab" size="20" maxlength="30">
						<label for="propinsi">Propinsi</label><input type="text" name="propinsi" id="propinsi" size="20" maxlength="30">
						<label for="kodepos">Kode Pos</label><input type="text" name="kodepos" id="kodepos" size="5" maxlength="5">
					</fieldset>
                    <br>
					<fieldset>
					<legend>Keterangan Badan</legend>
						<label for="tinggi">Tinggi Badan (Cm)</label><input type="text" name="tinggi" id="tinggi" size="4" maxlength="4">
						<label for="berat">Berat Badan (Kg)</label><input type="text" name="berat" id="berat" size="4" maxlength="4">
						<label for="rambut">Rambut</label><input type="text" name="rambut" id="rambut" size="15" maxlength="30">
						<label for="bentukmuka">Bentuk Muka</label><input type="text" name="bentukmuka" id="bentukmuka" size="15" maxlength="30">
						<label for="warnakulit">Warna Kulit</label><input type="text" name="warnakulit" id="warnakulit" size="15" maxlength="30">
						<label for="cirikhas">Ciri-ciri Khas</label><input type="text" name="cirikhas" id="cirikhas" size="20" maxlength="30">
						<label for="cacat">Cacat Tubuh</label><input type="text" name="cacat" id="cacat" size="30" maxlength="30" value="-">
					</fieldset>
                    </fieldset>
					<br>
	                <fieldset>
					...
					<fieldset>
						...
						<label for="pangkat_sk_tgl">Tanggal SK</label><input type="text" name="pangkat_sk_tgl" id="pangkat_sk_tgl" size="10" maxlength="12" class="tanggal">
					...
					<fieldset>
						...
						<label for="penyelenggara">Instansi Penyelenggara</label><input type="text" name="penyelenggara" id="penyelenggara" size="20" maxlength="35">
					...
					<fieldset>
						...
						<label for="nmanak">Nama</label><input type="text" name="nmanak" id="nmanak" size="30" maxlength="30">
					...
					<legend>Keterangan Berkelakuan Baik</legend>
						<label for="skkb_pejabat">Pejabat</label><input type="text" name="skkb_pejabat" id="skkb_pejabat" size="20" maxlength="40">
						<label for="skkb_nomor">Nomor</label><input type="text" name="skkb_nomor" id="skkb_nomor" size="20" maxlength="30">
						<label for="skkb_tgl">Tanggal</label><input type="text" name="skkb_tgl" id="skkb_tgl" size="10" maxlength="15" class="tanggal">
					</fieldset>
					<br>
					<fieldset>
					<legend>Keterangan Berbadan Sehat</legend>
						<label for="sk_sehat_pejabat">Pejabat</label><input type="text" name="sk_sehat_pejabat" id="sk_sehat_pejabat" size="20" maxlength="40">
						<label for="sk_sehat_nomor">Nomor</label><input type="text" name="sk_sehat_nomor" id="sk_sehat_nomor" size="20" maxlength="30">
						<label for="sk_sehat_tgl">Tanggal</label><input type="text" name="sk_sehat_tgl" id="sk_sehat_tgl" size="10" maxlength="15" class="tanggal">
					</fieldset>
					<br>
					<legend>Keterangan Tambahan</legend>
						<label for="ket_tambah"></label><input type="text" name="ket_tambah" id="ket_tambah" size="35" maxlength="60">
					</fieldset>
					<br>
    ...
    <div id="dialog-confirm" title="Tambah pegawai"> 
...
<script type="text/javascript">
    $(function() {
        var isiPesan=$('#isipesan'),pnlPesan=$('#pnlpesan'),ttpPesan=$('#pnlpesan a.close'),
        ...
        btnTambahOrgKerja=$('#tambahorg_kerja'),formTambahPegawai=$('#formtambahpegawai'),tjabatan=$('#tjabatan'),tips = $(".validateTips"),
        tdiklat=$('#tdiklat');
		...
		formTambahPegawai.validate({
	        rules:{
	            nmlengkap:{required:true,teks:true},
	            nip:{required:true,digits:true,remote:"../lib/ajax.php?op=ceknippegawai"},
	            seksi:{notNull:true},
	        ...
	        messages:{
	            ...
	            nip:{
	                ...
	                remote:"NIP pegawai sudah terpakai"
	            },
	    ...
	    seksi.change(function(){
	        if($(this).val()!=null){
                $.ajax({
                    url:'../lib/ajax.php?op=listjabatanbysuk&unitkerja='+unitKerja.val()+'&seksi='+escape($(this).val()),
                    type:'GET',
                    timeout:10000,
                    dataType: 'json',
                    success:function(data){
